...
// Bank.cpp
/* A C++ program I created for a Banking Management System where you can create an account, search for an account,
delete an account, deposit money into account or withdraw money from account. Once you have done what you need, you can then proceed to leave the bank. */
